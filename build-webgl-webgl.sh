...
# WebGL Build Script for webgl
# Usage: ./build-webgl-webgl.sh

echo "🎮 Building WebGL for webgl..."

# Set build path
BUILD_PATH="/workspace/webgl/Build"
...
if [ -f "/workspace/webgl/platform-configs/webgl.json" ]; then
    cp "/workspace/webgl/platform-configs/webgl.json" "$BUILD_PATH/PlatformConfigs/"
fi
...
echo "✅ WebGL build for webgl completed!"
