...
app.post('/api/game/level-complete', async (req, res) => {
    try {
        const { level, score, timeSpent, movesUsed, starsEarned, powerupsUsed, playerId, sessionId } = req.body;
...
app.get('/api/game/leaderboard', async (req, res) => {
    try {
        ...
        const leaderboard = await cloudServices.awsClients.dynamodb.send(new cloudServices.awsClients.dynamodb.ScanCommand({
...
export default app;
//# sourceMappingURL=game-api-example.js.map