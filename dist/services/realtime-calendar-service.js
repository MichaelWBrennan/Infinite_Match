...
class RealtimeCalendarService {
    ...
    async getCurrentEvents(timezone = this.timezone) {
        ...
        return await this.getCalendarEvents(now.format('YYYY-MM-DD HH:mm:ss'), now.format('YYYY-MM-DD HH:mm:ss'), timezone);
    }
    /**
     * Get upcoming events
     */
    async getUpcomingEvents(hours = 24, timezone = this.timezone) {
        ...
        return await this.getCalendarEvents(now.format('YYYY-MM-DD HH:mm:ss'), future.format('YYYY-MM-DD HH:mm:ss'), timezone);
    }
    /**
    ...
    async loadCachedCalendarData() {
        try {
            ...
            await this.getCalendarEvents(startOfDay.format('YYYY-MM-DD HH:mm:ss'), endOfDay.format('YYYY-MM-DD HH:mm:ss'));
...
//# sourceMappingURL=realtime-calendar-service.js.map