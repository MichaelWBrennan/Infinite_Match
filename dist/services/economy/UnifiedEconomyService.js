...
class UnifiedEconomyService {
    ...
    hasRequiredFields(obj, requiredFields) {
        return requiredFields.every((field) => Object.prototype.hasOwnProperty.call(obj, field) && obj[field] !== '');
    }
    /**
    ...
    async generateReport() {
        try {
            ...
            throw new ServiceError(`Failed to generate economy report: ${error.message}`, 'UnifiedEconomyService');
        }
    }
    /**
...
//# sourceMappingURL=UnifiedEconomyService.js.map