...
export class ReceiptVerificationService {
    ...
    static async verifyAndroidPurchase(payload) {
        ...
        try {
            ...
            if (!acknowledged) {
                try {
                    const ackUrl = `https://androidpublisher.googleapis.com/androidpublisher/v3/applications/${encodeURIComponent(packageName)}/purchases/products/${encodeURIComponent(productId)}/tokens/${encodeURIComponent(purchaseToken)}:acknowledge`;
...
//# sourceMappingURL=ReceiptVerificationService.js.map