...
export class PricingService {
    constructor(tiersPath = 'config/pricing/tiers.json', overridesPath = AppConfig.payments?.pricing?.countryOverridesPath ||
    ...
    roundPrice(amount) {
        if (amount < 2)
            return Math.round(amount * 100) / 100; // keep cents for very low
