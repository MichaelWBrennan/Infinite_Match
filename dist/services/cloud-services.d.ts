declare const _default: OptimizedCloudServicesManager;
 ...
 */
declare class OptimizedCloudServicesManager {
    awsClients: {};
    googleClients: {};
    azureClients: {};
    ...
    initializeAWSServices(): Promise<void>;
    initializeGoogleCloudServices(): Promise<void>;
    initializeAzureServices(): Promise<void>;
    initializeRedis(): Promise<void>;
    initializeMongoDB(): Promise<void>;
    setupHealthChecks(): void;
    setupRetryPolicies(): void;
    setupCircuitBreakers(): void;
