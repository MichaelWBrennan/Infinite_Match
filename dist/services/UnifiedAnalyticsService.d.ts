...
declare class UnifiedAnalyticsService {
    ...
    dailyStreaks: Map<any, any>;
    comebackBonuses: Map<any, any>;
    fomoEvents: Map<any, any>;
    variableRewards: Map<any, any>;
    /**
     ...
     */
    initializeExternalServices(): Promise<void>;
    /**
     ...
     */
    initializeAmplitude(): Promise<void>;
    /**
     * Initialize Datadog RUM for real user monitoring
     */
    initializeDatadog(): Promise<void>;
    /**
     ...
     */
    initializeMongoDB(): Promise<void>;
    /**
     * Initialize AI models for insights and predictions
     */
    initializeAIModels(): Promise<void>;
    /**
     ...
     */
    startDataFlushing(): void;
    /**
     * Get files in directory
     */
    getFilesInDirectory(dirPath: any): Promise<string[]>;
    /**
     ...
     */
    trackWithExternalServices(eventName: any, eventData: any, userId: any): Promise<void>;
    /**
     * Track specific game events with enhanced context
     */
    trackGameStart(userId: any, gameData: any): Promise<void>;
    trackLevelComplete(userId: any, levelData: any): Promise<void>;
    trackMatchMade(userId: any, matchData: any): Promise<void>;
    trackPowerUpUsed(userId: any, powerUpData: any): Promise<void>;
    trackPurchase(userId: any, purchaseData: any): Promise<void>;
    trackError(userId: any, errorData: any): Promise<void>;
    /**
     * Track performance metrics
     */
    trackPerformance(userId: any, performanceData: any): Promise<void>;
    /**
     * Generate AI insights
     */
    generateInsights(userId: any): Promise<{
        type: string;
        confidence: number;
     ...
     */
    predictChurn(userId: any): Promise<number>;
    /**
     * Predict player LTV
     */
    predictLTV(userId: any): Promise<number>;
    /**
     * Analyze difficulty needs
     */
    analyzeDifficulty(userId: any): Promise<{
     ...
     * Get player profile
     */
    getPlayerProfile(userId: any): Promise<any>;
    /**
     ...
     * Clean old files
     */
    cleanOldFiles(type: any): Promise<void>;
    /**
     * Anonymize user data
     */
    anonymizeUserId(userId: any): string;
    anonymizeIP(ip: any): string;
    anonymizeProperties(properties: any): any;
    /**
     * Hash string for anonymization
     */
    hashString(str: any): string;
    /**
     * Get user agent
     */
    getUserAgent(): string;
     ...
     */
    checkDailyRewardEligibility(userId: any): Promise<void>;
    /**
     * Trigger comeback bonus for returning player
     */
    triggerComebackBonus(userId: any): Promise<void>;
    /**
     * Claim daily reward
     */
    claimDailyReward(userId: any): Promise<{
        success: boolean;
        message: string;
        reward?: never;
    } | {
     ...
     * Create FOMO event
     */
    createFOMOEvent(eventType: any, eventData: any): Promise<{
        id: string;
        type: any;
        data: any;
        createdAt: Date;
     ...
     */
    trackVariableReward(userId: any, rewardType: any, rewardValue: any, rarity: any): Promise<void>;
    /**
     * Get addiction mechanics data for player
     */
    getAddictionData(userId: any): {
        dailyStreak: any;
        maxStreak: any;
        hasClaimedToday: any;
        activeFOMOEvents: any[];
        recentRewards: any[];
        comebackBonuses: any[];
    };
}
//# sourceMappingURL=UnifiedAnalyticsService.d.ts.map