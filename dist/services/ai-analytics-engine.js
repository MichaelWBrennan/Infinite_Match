...
Return JSON with:
{
  ...
  "recommendations": [
    ...
    async startDataProcessor() {
        if (this.isProcessingData || this.dataProcessingQueue.length === 0)
            return;
    ...
    async processPlayerBehaviorData(data) {
        ...
        const updatedMetrics = {
            ...
            averageScore: this.calculateMovingAverage(currentMetrics.averageScore || 0, behavior.score || 0, currentMetrics.sessionCount || 0),
        };
    ...
    async processEngagementData(data) {
        ...
        const updatedEngagement = {
            ...currentEngagement,
            current: engagement,
            average: this.calculateMovingAverage(currentEngagement.average || 0, engagement, currentEngagement.sampleCount || 0),
...
//# sourceMappingURL=ai-analytics-engine.js.map