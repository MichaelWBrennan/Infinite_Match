...
router.post('/receipt/verify', security.authRateLimit, [
...
router.get('/pricing', security.sessionValidation, [query('country').optional().isString(), query('currency').optional().isString()], async (req, res) => {
    try {
