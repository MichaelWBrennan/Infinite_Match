    ...
    setupRoutes() {
        ...
        this.app.post('/api/content/generate/:playerId', async (req, res) => {
            try {
                ...
                const content = await this.industryLeaderEngine.generateContentForPlayer(playerId, contentType, preferences);
                res.json({
                    success: true,
                    content: content,
                });
        ...
        this.app.post('/api/personalization/content/:playerId', async (req, res) => {
            try {
                const { playerId } = req.params;
                const { contentType, preferences } = req.body;
                const content = await this.industryLeaderEngine.aiPersonalizationEngine.generatePersonalizedContent(playerId, contentType, preferences);
                res.json({
                    success: true,
                    content: content,
                });
        ...
        this.app.get('/api/personalization/offers/:playerId', async (req, res) => {
            try {
                ...
                const offers = await this.industryLeaderEngine.aiPersonalizationEngine.generatePersonalizedOffers(playerId, parseInt(count));
                res.json({
                    success: true,
                    offers: offers,
                });
        ...
        this.app.post('/api/personalization/difficulty/:playerId', async (req, res) => {
            try {
                ...
                const difficulty = await this.industryLeaderEngine.aiPersonalizationEngine.personalizeDifficulty(playerId, levelId, currentPerformance);
                res.json({
                    success: true,
        ...
        this.app.post('/api/personalization/timing/:playerId', async (req, res) => {
            try {
                ...
                const timing = await this.industryLeaderEngine.aiPersonalizationEngine.optimizeContentTiming(playerId, contentType, contentData);
                res.json({
                    success: true,
                    timing: timing,
                });
...
//# sourceMappingURL=industry-leader-server.js.map