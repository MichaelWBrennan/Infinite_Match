...
namespace Evergreen.Editor
{
    ...
    public class PokiWebGLBuildScript : EditorWindow
    {
        ...
        private string GeneratePokiHTMLContent()
        {
            ...
            html.AppendLine("            </div>");
            html.AppendLine("        </div>");
        html.AppendLine("        <div id=\"unity-mobile-warning\" style=\"display: none;\">");
        html.AppendLine("            <div class=\"mobile-warning-content\">");
        html.AppendLine("                <h3>📱 Mobile WebGL Support</h3>");
        html.AppendLine("                <p>This game now supports mobile devices! Optimizing for your device...</p>");
        html.AppendLine("                <div class=\"mobile-optimization-status\">");
        html.AppendLine("                    <div class=\"status-item\">");
        html.AppendLine("                        <span class=\"status-label\">Device Detection:</span>");
        html.AppendLine("                        <span class=\"status-value\" id=\"device-status\">Checking...</span>");
        html.AppendLine("                    </div>");
        html.AppendLine("                    <div class=\"status-item\">");
        html.AppendLine("                        <span class=\"status-label\">Performance Level:</span>");
        html.AppendLine("                        <span class=\"status-value\" id=\"performance-status\">Detecting...</span>");
        html.AppendLine("                    </div>");
        html.AppendLine("                    <div class=\"status-item\">");
        html.AppendLine("                        <span class=\"status-label\">Touch Support:</span>");
        html.AppendLine("                        <span class=\"status-value\" id=\"touch-status\">Enabling...</span>");
        html.AppendLine("                    </div>");
        html.AppendLine("                </div>");
        html.AppendLine("            </div>");
        html.AppendLine("        </div>");
