// Shared Game Logic for All Platforms
// This ensures consistent game behavior across Vercel, WebGL, and all other platforms

class SharedMatch3Game {
    constructor() {
        this.boardSize = 8;
    ...
    createUI() {
        ...
        if (!document.querySelector('.game-controls')) {
            ...
            gameControls.innerHTML = `
                <button class="btn" onclick="sharedGame.startNewGame()">New Game</button>
                <button class="btn secondary" onclick="sharedGame.pauseGame()">Pause</button>
                <button class="btn success" onclick="sharedGame.usePowerUp()">Power Up</button>
            `;
    ...
    showGameOver() {
        ...
        gameOver.innerHTML = `
            ...
            <button class="btn" onclick="sharedGame.startNewGame()">Play Again</button>
        `;
...
function startNewGame() {
    if (window.sharedGame) {
        window.sharedGame.startNewGame();
    } else {
        console.log('Shared game not initialized yet');
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    sharedGame = new SharedMatch3Game();
    window.sharedGame = sharedGame;
});

// Make it globally available
window.SharedMatch3Game = SharedMatch3Game;