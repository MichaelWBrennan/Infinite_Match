    ...
    async createEvent(eventData) {
        try {
            const event = {
                ...
                start_time: moment.tz(eventData.startTime, eventData.timezone || 'UTC').utc().toISOString(),
                end_time: moment.tz(eventData.endTime, eventData.timezone || 'UTC').utc().toISOString(),
