            ...
            try:
                with open(self.unity_config_path, 'r') as f:
                    ...
                    if config_project_id == self.project_id:
                        ...
                        print(f"❌ Project ID consistency: FAILED - Config: {config_project_id}, Expected: {self.project_id}")
            ...
            try:
                with open(self.unity_config_path, 'r') as f:
                    ...
                    if config_env_id == self.environment_id:
                        ...
                        print(f"❌ Environment ID consistency: FAILED - Config: {config_env_id}, Expected: {self.environment_id}")
