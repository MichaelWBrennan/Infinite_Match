...
class HeadlessUnityWithCredentials:
    ...
    def get_unity_credentials(self):
        ...
        try:
            ...
            result = subprocess.run(
                ["cursor", "getSecret", "UNITY_CLIENT_ID"],
                capture_output=True,
                text=True,
                timeout=10,
            )
            ...
            result = subprocess.run(
                ["cursor", "getSecret", "UNITY_CLIENT_SECRET"],
                capture_output=True,
                text=True,
                timeout=10,
            )
    ...
    def read_authenticated_economy_data(self, access_token):
        ...
        try:
            ...
            currencies_response = requests.get(
                f"{self.economy_url}/configs/currencies", headers=headers, timeout=15
            )
            ...
            inventory_response = requests.get(
                f"{self.economy_url}/configs/inventory", headers=headers, timeout=15
            )
            ...
            catalog_response = requests.get(
                f"{self.economy_url}/configs/catalog", headers=headers, timeout=15
            )
            ...
            if economy_data["authenticated_data"]:
                ...
                print(
                    "✅ Economy Data: Successfully read from Unity Cloud with authentication"
                )
            else:
    ...
    def read_authenticated_remote_config_data(self, access_token):
        ...
        try:
            ...
            config_response = requests.get(
                f"{self.remote_config_url}/configs", headers=headers, timeout=15
            )
            ...
            if remote_config_data["authenticated_data"]:
                ...
                print(
                    "✅ Remote Config Data: Successfully read from Unity Cloud with authentication"
                )
            else:
    ...
    def read_authenticated_cloud_code_data(self, access_token):
        ...
        try:
            ...
            functions_response = requests.get(
                f"{self.cloud_code_url}/scripts", headers=headers, timeout=15
            )
            ...
            if cloud_code_data["authenticated_data"]:
                ...
                print(
                    "✅ Cloud Code Data: Successfully read from Unity Cloud with authentication"
                )
            else:
    ...
    def generate_authenticated_report(self):
        ...
        for service_name, service_data in self.results[
            "authenticated_account_data"
        ].items():
        ...
        if successful_services > 0:
            ...
            print(
                "   - This is what's really on your account (read with authentication)"
            )
    ...
    def save_results(self):
        ...
        results_file = (
            results_dir / f"authenticated_unity_cloud_reader_{timestamp}.json"
        )
