...
class UnityDashboardSetupAssistant:
    ...
    def open_dashboard_section(self, section, url_suffix=""):
        ...
        base_url = f"https://dashboard.unity3d.com/organizations/{self.project_id}/projects/{self.project_id}/environments/{self.environment_id}"
    ...
    def setup_economy_currencies(self, config):
        ...
        self.print_step(1, "Create Currencies", "Setting up 3 currencies in Unity Dashboard")
    ...
    def setup_economy_purchases(self, config):
        ...
        self.print_step(3, "Create Virtual Purchases", "Setting up 20 virtual purchases")
        ...
        for i, purchase in enumerate(virtual_purchases, 1):
            ...
            print(f"   Cost: {purchase['cost']['amount']} {purchase['cost']['currency']}")
            print(f"   Rewards: {purchase['rewards'][0]['amount']} {purchase['rewards'][0]['currency']}")
            print(f"   Steps:")
    ...
    def setup_cloud_code(self):
        ...
        self.print_step(5, "Deploy Cloud Code Functions", "Deploy 4 Cloud Code functions")
    ...
    def run_setup(self):
        ...
        print("🎯 This assistant will guide you through setting up Unity Cloud Services")
