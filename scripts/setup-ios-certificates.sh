...
echo "🍎 Setting up iOS Certificates for Infinite Match..."
...
echo "   - Description: Infinite Match"
echo "   - Bundle ID: com.infinite.match"
...
echo "   - Select iOS App Development > Continue"
echo "   - Select App ID: com.infinite.match > Continue"
...
echo "   - Name: Infinite Match App Store > Generate"
echo "   - Download and install profile"
echo ""
...
echo "   - Select App ID: com.infinite.match > Continue"
echo "   - Select Distribution Certificate > Continue"
echo "   - Name: Infinite Match TestFlight > Generate"
echo "   - Download and install profile"
echo ""
...
echo "   - Bundle Identifier: com.infinite.match"
...
echo "codesign -dv --verbose=4 build/iOS/InfiniteMatch.app"
echo ""
