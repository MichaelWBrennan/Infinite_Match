...
class SecurityTester:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test(
                    ...
                    True,
                    "Server is healthy",
                    {"status": data.get("status"), "uptime": data.get("uptime")},
                )
                return True
            else:
                self.log_test(
            ...
            if response.status_code == 200:
                ...
                if data.get("success"):
                    ...
                    self.log_test(
                        ...
                        True,
                        "Login successful",
                        {"player_id": player_id, "has_token": bool(self.auth_token)},
                    )
                    return True
                else:
                    self.log_test(
                ...
                self.log_test(
                    "Authentication",
                    False,
                    f"Login request failed with status {
                        response.status_code}",
                )
                return False
    ...
    def test_rate_limiting(self):
        ...
        try:
            ...
            if rate_limit_triggered:
                self.log_test(
                    "Rate Limiting", True, "Rate limiting triggered correctly"
                )
                return True
            else:
    ...
    def test_input_validation(self):
        ...
        try:
            ...
            response = self.session.post(
                f"{self.base_url}/game/submit_data", json=malicious_data
            )
            ...
            if response.status_code in [200, 400]:
                ...
                if response.status_code == 400:
                    ...
                    if "<script>" not in str(data):
                        self.log_test(
                            "Input Validation", True, "Malicious input sanitized"
                        )
                    else:
                        self.log_test(
                            "Input Validation", False, "Malicious input not sanitized"
                        )
                return True
            else:
                self.log_test(
            ...
            self.log_test(
                "Input Validation",
                False,
                f"Input validation test failed: {
                    str(e)}",
            )
            return False
    ...
    def test_anti_cheat_validation(self):
        ...
        try:
            ...
            response = self.session.post(
                f"{self.base_url}/game/submit_data", json=impossible_data
            )
            ...
            if response.status_code == 400:
                ...
                if "Invalid game data" in data.get("error", ""):
                    ...
                    self.log_test(
                        "Anti-Cheat Validation", False, "Impossible values not detected"
                    )
                    return False
            else:
                self.log_test(
            ...
            self.log_test(
                "Anti-Cheat Validation", False, f"Anti-cheat test failed: {str(e)}"
            )
            return False
    ...
    def test_speed_hack_detection(self):
        ...
        try:
            ...
            for i in range(10):
                ...
                response = self.session.post(
                    f"{self.base_url}/game/submit_data", json=speed_hack_data
                )

                if response.status_code == 400:
                    data = response.json()
                    if (
                        "suspicious" in data.get("error", "").lower()
                        or "speed" in data.get("error", "").lower()
                    ):
                        self.log_test(
    ...
    def test_security_headers(self):
        ...
        try:
            ...
            self.log_test(
                "Security Headers",
                False,
                f"Security headers test failed: {
                    str(e)}",
            )
            return False
    ...
    def test_session_management(self):
        ...
        try:
            ...
            self.log_test(
                "Session Management",
                False,
                f"Session management test failed: {
                    str(e)}",
            )
            return False
