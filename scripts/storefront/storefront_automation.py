...
class StorefrontAutomation:
    ...
    def generate_changelog(self):
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                changelog += f"**Build Date:** {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n\n"
    ...
    def get_version(self):
        ...
        try:
            project_settings = self.repo_root / "unity" / "ProjectSettings" / "ProjectSettings.asset"
        ...
        try:
            ...
            platforms = {
                ...
                "steam": {
                    ...
                    "supported_languages": ["English", "Spanish", "French", "German", "Japanese", "Korean", "Portuguese", "Russian", "Chinese"]
                },
                "itch": {
    ...
    def deploy_to_google_play(self):
        ...
        try:
            ...
            result = subprocess.run(fastlane_cmd, cwd=self.repo_root / "deployment" / "fastlane")
    ...
    def deploy_to_itch(self):
        ...
        try:
            ...
            butler_cmd = [
                "butler", "push", str(webgl_dir),
                f"{self.itch_username}/{self.itch_game}:web",
                "--userversion", self.get_version()
            ]
