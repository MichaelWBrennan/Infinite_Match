...
export declare function startTelemetryCollection(telemetryService: TelemetryService, configuration: Configuration, hooks: AbstractHooks, observable: Observable<TelemetryEvent & Context>, metricSampleRate?: number): {
    enabled: boolean;
    metricsEnabled: boolean;
};
