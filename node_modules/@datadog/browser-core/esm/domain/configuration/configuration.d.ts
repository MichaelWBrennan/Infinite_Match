...
export declare const DefaultPrivacyLevel: {
    ...
    readonly MASK_UNLESS_ALLOWLISTED: "mask-unless-allowlisted";
};
...
export declare function validateAndBuildConfiguration(initConfiguration: InitConfiguration, errorStack?: string): Configuration | undefined;
