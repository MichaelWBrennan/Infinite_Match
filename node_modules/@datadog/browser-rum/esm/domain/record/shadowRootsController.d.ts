...
export declare const initShadowRootsController: (configuration: RumConfiguration, scope: SerializationScope, callback: (record: BrowserIncrementalSnapshotRecord) => void, elementsScrollPositions: ElementsScrollPositions) => ShadowRootsController;
